'''
The following code calculates the probability that two people in a room
of n people have the same birthday, then runs a simulation to see if
in a single instance there is a match of birthdays. 
'''
import random
...
'''
The program clusters different data points as either vampires, programmers, or zombies 
based on where they fall in the data.
'''
