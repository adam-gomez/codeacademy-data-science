...
for i in range(len(estimated_insurance_data)):
  insurance_cost_difference.append((estimated_insurance_data[i][0], estimated_insurance_data[i][1] - insurance_data[i][1]))

print(f'The differences between the estimates and the actual costs (estimate - actual): {insurance_cost_difference}')