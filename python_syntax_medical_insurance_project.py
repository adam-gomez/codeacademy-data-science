...
new_insurance_cost = new_insurance_cost = 250 * age - 128 * sex + 370 * bmi + 425 * num_of_children + 24000 * smoker - 12500

change_in_insurance_cost = new_insurance_cost - insurance_cost

print(f"The change in cost of insurance after increasing BMI by 3.1 is {change_in_insurance_cost} dollars.")
...
print(f"The change in estimated cost for having 10 children instead of 3 is  {change_in_insurance_cost} dollars.")